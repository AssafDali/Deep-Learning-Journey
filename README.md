...
Welcome to my Deep Learning projects repository. This collection showcases various architectures and techniques implemented during my studies.

## Projects

### 1. [CNN Fashion-MNIST Classification](./03-CNN-Fashion-MNIST/)
Description: A Convolutional Neural Network (CNN) implementation using PyTorch to classify the Fashion-MNIST dataset. This project demonstrates the ability to build and train deep learning models for computer vision tasks, moving beyond basic architectures to include regularization and performance optimization.

Key Features:
Custom CNN Architecture: Implementation of multiple convolutional and pooling layers.
...
Key Features:
Optimizer Comparison: Evaluating the performance of Adam vs. SGD and other optimization algorithms.
...
Key Features:
Recurrent Architecture: Implementation of a balanced LSTM model in PyTorch.
